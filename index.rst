...
InGateway902边缘计算网关是映翰通面向IoT领域，助力IoT行业实现数字化转型而重磅推出的新一代边缘计算网关，拥有强劲的边缘计算能力，分担部署在云端的计算资源，在物联网边缘节点实现数据优化、实时响应、敏捷连接、模型分析等业务，使AI时代下的数字化物联网更进一步。
...
.. toctree::
   ...
   IG974-Quick-Start-Manual-CN.md

.. toctree::
   :maxdepth: 2
   :caption: IG502用户手册

   IG502-Quick-Start-Manual-CN.md
